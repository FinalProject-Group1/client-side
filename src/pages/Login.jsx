...
const Login = () => {
	...
	const [phoneNumber, setPhoneNumber] = useState('6287872453919');
	...
	return (
		<div className="w-full h-screen py-8 px-8 md:py-20 md:px-20 bg-[url('/bg-terra-2.jpg')]">
			<div className="w-full h-full flex flex-row rounded-2xl">
				<div className="w-full md:w-1/2 h-full px-6 md:px-20 flex flex-col items-center rounded-2xl md:rounded-e-none md:rounded-s-2xl backdrop-blur-lg bg-opacity-70 bg-slate-100 hover:bg-opacity-100 transition-opacity">
