...
const Register = () => {
  ...
  return (
    <div className="w-full h-auto py-20 px-20 bg-[url('/bg-terra-2.jpg')]">
      <div className="w-full h-full flex flex-row rounded-2xl">
        <div className="w-1/2 h-full px-20 flex flex-col items-center rounded-s-2xl bg-white">
          <div className="w-1/2 flex rounded-xl mb-2 mt-5">
            <button
