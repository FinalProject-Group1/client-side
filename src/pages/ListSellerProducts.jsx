...
const ListSellerProducts = () => {
	...
	return (
		<div className="w-full min-h-screen px-20 py-10 flex flex-col gap-4">
			<div>
			...
			<div className="w-full flex justify-between relative my-6">
				<div className="absolute top-[34px] w-full h-1 bg-green-primary rounded-full"></div>
				<div className="flex flex-col items-start gap-1">
					<p className="font-medium">Murah</p>
					<div className="w-4 h-4 bg-green-primary rounded-full"></div>
